        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'p.model') { ?>
                ...
                <?php } ?></td>
              <td class="left" style="display:none" ><?php if ($sort == 'p.price') { ?>
                <a href="<?php echo $sort_price; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_price; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_price; ?>"><?php echo $column_price; ?></a>
                <?php } ?></td>
              <td class="right" style="display:none" ><?php if ($sort == 'p.quantity') { ?>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td align="left" style="display:none"><input type="text" name="filter_price" value="<?php echo $filter_price; ?>" size="8"/></td>
            ...
            <tr>
              ...
              <td class="left" style="display:none"><?php if ($product['special']) { ?>
                <span style="text-decoration: line-through;"><?php echo $product['price']; ?></span><br/>
                <span style="color: #b00;"><?php echo $product['special']; ?></span>
                <?php } else { ?>
                <?php echo $product['price']; ?>
                <?php } ?></td>
              <td class="right"  style="display:none"><?php if ($product['quantity'] <= 0) { ?>
