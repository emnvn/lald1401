...
class ControllerCatalogCategory extends Controller { 
	...
	private function getForm() {
		...
		$this->data['news_categories'] = $this->model_fido_news->getNewsAllCategory();
		$this->data['news_categories'] = $this->data['news_categories'][$this->config->get('config_language_id')];
		
		if (isset($this->request->post['news_category_id'])) {
			$this->data['news_category_id'] = $this->request->post['news_category_id'];
		} elseif (!empty($category_info)) {
			$this->data['news_category_id'] = $category_info['news_category_id'];
		} else {
