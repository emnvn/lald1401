...
class ControllerModuleNews extends Controller {
	...
	private function getList() {
		...
		foreach ($results as $result) {
			...
			$categories = $this->model_fido_news->getCategoryByNews($result['news_id']);
			$this->data['news'][] = array(
	...
	private function getForm() {
		...
		if (isset($this->request->post['news_category'])) {
			...
			$this->data['news_category'] = $this->model_fido_news->getCategoriesByNews($this->request->get['news_id']);
		} else {
			$this->data['news_category'] = array(0);
		}
