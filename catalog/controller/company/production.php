...
class ControllerCompanyProduction extends Controller {
	...
	static $category_id = 73;
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/company/production.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/company/production.tpl';
		} else {
			$this->template = 'default/template/company/production.tpl';
		}
