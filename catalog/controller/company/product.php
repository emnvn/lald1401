<?php  
class ControllerCompanyProduct extends Controller {
	private $error = array(); 
	...
	public function index() { 
		...
		if ($product_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/company/product.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/company/product.tpl';
			} else {
				$this->template = 'default/template/company/product.tpl';
			}
