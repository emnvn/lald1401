...
<div id="content"><?php echo $content_top; ?>
  ...
  <div id="tab-review" class="tab-content">
    ...
    <div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:comments href="http://www.toplondoner.com/index.php?route=product/product&product_id=<?php print $product_id;?>" num_posts="10" width="550"></fb:comments>
	</div>
  <?php } ?>
  <?php if ($products) { ?>
